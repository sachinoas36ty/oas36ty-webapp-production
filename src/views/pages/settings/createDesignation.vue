<template>
        ...
        <b-modal no-close-on-backdrop id="designation-modal" ref="designation-modal" size="lg" title="add designation" class="b-overlay position-relative"
            hide-footer>
            {{ all_masters }}
    ...
    desig_type.text = 'ToggleLeftIcon'
            ...
            <div v-if="$store.state.designation.isSidebarLoading" class="b-overlay position-absolute"
            ...
            <div class="position-absolute d-flex align-items-center flex-column" style="top: 50%; left: 50%; transform: translateX(-50%) translateY(-50%);">
              ...
              <br><span>Adding Designation..</span>
            </div>
          </div>
        </b-modal>
