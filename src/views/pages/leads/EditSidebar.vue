      ...
      <b-form @submit.prevent="handleSubmit(onSubmit())">
        ...
        <b-row>
          <b-col :md="setMd(branches.length)">
            ...
            rules="required"
          >
            <b-form-group v-if="$router.currentRoute.name == 'leads'"  label="Contact Person *">
          ...
          <b-col md="3">
            <validation-provider #default="validationContext" name="due_date" vid="due_date" rules="required">
              ...
              <b-form-group label="Due Date *">
                <VueDatePicker format="DD-MM-YYYY" @input="openReason()" style="border:1px solid #d8d6de;border-radius: 0.357rem;" v-model="formData.due_date" :minDate="currentDate" />
