<template>
    ...
    <div >
       {{ defaultEmail }}
      <b-modal no-close-on-backdrop id="modal-new-leads" ref="modal-new-leads" size="lg" hide-footer >
        <!-- <b-card-body> -->
        ...
        <validation-observer #default="{ handleSubmit }" ref="refFormObserver">
          ...
          <b-form @submit.prevent="handleSubmit(onSubmit)">
            ...
            <b-row>
              <b-col :md="setMd(branches.length)">
                ...
                <validation-provider #default="validationContext" name="branch_id" vid="branch" rules="required">
                  ...
                  <b-form-group label="Branch *" v-if="isChecked==true"  class="my-custom-select">
                ...
                <b-form-group v-if=" $router.currentRoute.name == 'GettingStarted' " label="Contact Person"  class="my-custom-select">
              ...
              <b-col :md="setMd(branches.length)">
                <validation-provider #default="validationContext" name="company_id" vid="client" 
                 >
                  <b-form-group label="Client " v-if="isChecked==false"  class="my-custom-select">
                ...
                <b-form-group v-if=" $router.currentRoute.name == 'GettingStarted' " label="Client"  class="my-custom-select">
                  <v-select id="client" :options="clients" label="name" v-model="formData.company_id"
                    placeholder="Search Client">
                    <template #list-header class="add_clients">
                      <div class=" ml-2 mb-1 mt-1" v-b-modal.modal-clients>
              ...
              <b-col :md="setMd(branches.length)">
                <b-form-group label="Category" v-if="isChecked==false"  class="my-custom-select">
              ...
              <b-col :md="setMd(branches.length)" v-if="(branches.length > 1)">
                <validation-provider #default="validationContext" name="branch_id" vid="branch" rules="required">
                  ...
                  <b-form-group label="Branch *" v-if="isChecked==false"  class="my-custom-select">
                    <v-select   id="branch" placeholder="Search Branch"
                      v-model="formData.branch_id" label="name" :options="branches">
                      <template #option="item">
                        <span v-b-tooltip.hover.top="item.name">
            ...
            /> -->
              ...
              <b-col v-if="$router.currentRoute.name == 'tasks'" :md="setSpecialMd()">
                    ...
                    <div style="padding-left: 4rem;width: 50%;">
                      <div class="border-l" style="">
                          ...
                          <div class="d-flex justify-content-between align-items-center p-1 border-bottom-light bg-light">
                            ...
                            <div>
                              ...
                              <b-dropdown id="file_drop" class="" style="width:50%;" variant="primary" size="sm">
                                ...
                                <b-dropdown-item><img class="mr-1"
                                    :src="slideIcon"
                                    width="25px" data-type="3">Google Slides</b-dropdown-item>
                        ...
                        <div class="d-flex justify-content-between align-items-center p-1" >
                          <div  v-if="file_name3.length  > 0 " class="d-flex justify-content-between">
                            <div v-for="(file, index) in linkWithUrl" :key="index"
