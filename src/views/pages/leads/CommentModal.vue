        ...
        <validation-observer #default="{ handleSubmit }" ref="refFormObserver">
          <b-form @submit.prevent="handleSubmit(onSubmit)">
              ...
              <b-col :md="'7'">
                ...
                >
                  <b-form-input
                    ...
                    placeholder="Enter comments and mention @someone"
                  >
                  </b-form-input>
                  <!-- <create-contact/> -->
                  <b-form-invalid-feedback
            ...
            <div class="mt-1 text-right">
              ...
              <b-button
                size="sm"
                :disabled="$store.state.comments.isLoading"
                variant="primary"
                type="submit"
              >
                Save
        ...
        >
          ...
          >
            <span aria-hidden="true" class="spinner-border text-primary">
              <!----></span
            >
            <br /><span>Adding New Comments..</span>
          </div>
        </div>
      </b-modal>
    </div>
    ...
    onSubmit() {
      ...
      this.$store
        ...
        .then(() => {
          ...
          // this.$store.dispatch("comments/fetch", data.task_id).then(() => {
          //   this.resetFormData()
          // })
        })
    },
