...
<div >
  ...
  <b-table  id="leads_table" :filterIncludedFields="['priority']" :show-empty="!isLoading && items.length == 0"
        :filter="FilterPriority != null ? FilterPriority.id : ''" :per-page="perPage" :current-page="currentPage" :tbody-tr-class="rowClass"
        selectable responsive :items="items" :fields="fields" class="mb-0" @row-clicked="onRowClicked">
        <template #head()="{ label, field: { key } }">
          ...
          <input type="checkbox" v-else-if="key==='checkbox'"  id="mainCheckbox" @click="toggle234()" >
        ...
        <template #row-details="item">
          ...
          <b-card no-body class="ml-2 mt-2 mr-2 mb-0">
            <div class="d-flex justify-content-between" style="text-transform: uppercase; font-weight: 500;">
              ...
              <div>
                <!-- <feather-icon v-show="setPrivileges.edit === true" style="margin-right: 0.5rem;" @click="
                  isEditSidebarActive = true;
                editItem = item.item;
                                                                        " icon="EditIcon" size="20" />
                <feather-icon v-show="setPrivileges.delete === true" @click="destroyItem(item.item.id)" icon="TrashIcon"
                  size="20" /> -->
              </div>
            </div>
            ...
            <span v-if="item.item.users.length > 1">,</span> -->
                  ...
                  <b-row>
                    ...
                    <b-col md="10" style="width:63rem;">
                      ...
                      <!-- <iframe scrolling="no" onload="javascript:(function(o){o.style.height=o.contentWindow.document.body.scrollHeight+40+'px'; o.style.width = o.contentWindow.document.body.scrollWidth+5+'px'; scroll(0,0)}(this));"
   style="width: 63rem;max-width:63rem;pointer-events:auto;height: 8rem; border: 1px solid white" :srcdoc="shortText(false)" frameborder="0"></iframe> -->
                      <br/>
            ...
            <b-tab active id="lead">
              ...
              <div class="d-flex">
                <div style="line-height: 3; width: 32.333333333%;">
                  ...
                  <div class="text-center mt-1" id="desc_history_followups" style="
                            display: none;
                            border: 1px solid #e0e0e0;
                            line-height: 2.5;
                          ">
                  ...
                  <div class="text-center mt-1" id="desc_pending_followups" style="
                            display: none;
                            border: 1px solid #e0e0e0;
                            line-height: 2.5;
                          ">
                  ...
                  <div @click="showHideUpcomingFollowups()" class="mt-1" style="
                    ...
                    <span class="ml-1">
                      <b>
                        <feather-icon :icon="upcomingIconName" size="18" /> </b>Upcoming</span>
                  </div>
                  <div class="text-center mt-1" id="desc_upcoming_followups" style="
                            display: none;
                            border: 1px solid #e0e0e0;
                            line-height: 2.5;
                          ">
                    ...
                    ">
                      <span class="ml-1 d-flex justify-content-between">
                        <div @click=" showOrHideTaskAttach() " class="w-100 h-100">
                          ...
                          Task Attachments
                          <b-badge v-if=" showFilesTask.filter(e => e.attachment !== '' || e.drive_url !== '').length != 0 "
                            :variant=" 'secondary' ">
                                ...
                                <div
                                  ...
                                  <div>
                                    ...
                                    <b-dropdown size="sm" id="file_drop" class="" variant="primary">
                                      ...
                                      <b-dropdown-item v-b-modal.attachment-excel-modal><img class="mr-1" :src=" excelIcon "
                              ...
                              <div class="p-1">
                                ...
                                <div v-else-if=" fileLinks.filter(e => e.type === 'task').length ">
                                  <div v-for="( file, index ) in  fileLinks.filter(e => e.type === 'task') " :key=" index "
                                    ...
                                    ? file.original_name.substr(0, 35)
                                    : file.fileName
                                    }}
                    ...
                    ">
                      <div
                        ...
                        <div class="ml-1 d-flex justify-content-between" v-for="(  file, index  ) in   showFilesTask  "
                          v-if=" file.drive_url || file.attachment " :key=" index ">
                          ...
                          <b-dropdown id="file_options" variant="link">
                            ...
                            <b-dropdown-item @click=" openInDrive(file.drive_url ? file.drive_url : file.attachment,file.original_name) ">
                              Download
                            </b-dropdown-item>
                      ...
                      <div
                        ...
                        <div class="ml-1 d-flex justify-content-between" v-for="( file, index ) in  showFilesClient "
                          ...
                          <b-dropdown id="file_options" class="" size="sm" variant="link">
                            ...
                            <b-dropdown-item>Rename</b-dropdown-item>
                            <b-dropdown-item @click=" convertToClient(file.id) ">Add to Task</b-dropdown-item>
                      ...
                      <div v-if=" i.item.title == 'proposal' " class="d-flex justify-content-between align-items-end"
                        ...
                        <div>
                          <b-button size="sm" v-if="
                            getStatusForProposalNumber(i.item) < 100 ||
                              getStatusForProposalNumber(i.item) == null
                          " @click="
  () => {
...
" variant="primary ml-1">
                          ...
                          <b-button  v-if="getPercentProposal(i.item) === 0" @click="
                            () => {
                              editIndex = i.index;
    ...
    text-transform: none;" class="text-center mt-1" v-if=" item.item.time_sheet.length === 0 ">There are no records to
        ...
        <template #cell(priority)="data">
          ...
          <b-dropdown v-if="setPrivileges.onRowEdit === true" v-ripple.400="'rgba(113, 102, 240, 0.15)'"
            variant="flat-dark">
            <template #button-content>
        ...
        <template #cell(client)="item">
          <span class="client-name234" v-if="item.item.company != null" v-b-tooltip.hover.top="item.item.company.name">
        ...
        <template #cell(subject)="data">
          <span v-b-tooltip.hover.top="data.item.subject">
        ...
        <template #cell(daysLeft)="data">
          <b-dropdown v-if="setPrivileges.onRowEdit === true" id="days_left_drop" menu-class="w-100" class="w-100"
            ...
            <template #button-content>
              <span :class="{
                'text-red':
                  DaysLeft(data.item.created_at, data.item.due_date) < 0,
              }">
                {{
            ...
            <template v-slot:default>
              <b-dropdown-item  v-b-modal.modal-due-date @click="getTaskId(data.item.id)">
                <span> Today </span>
              </b-dropdown-item>
              <b-dropdown-item  v-b-modal.modal-due-date @click="getTaskId(data.item.id)">
                <span> Tomorrow </span>
   ...
   <b-form-group id="open_datepicker2" >
                  ...
                  <!-- <flat-pickr style="border:1px solid" v-model="startDate2" :config="{ minDate: 'today', altInput: false }" id="flatpickr-date"
                    class="form-control cursor-pointer border-bottom" @input="inline_due_date(startDate2, data.item.id)"
      ...
      <b-col cols="12" class="my-2" > -->
              <!--  <b-button size="sm" @click="document.getElementById('enable_datepicker').click">Choose Date</b-button>{{startDate2}} -->
  ...
  />
        ...
        <template #cell(employees)="data">
          <span class="d-flex ">
            <b-dropdown v-if="setPrivileges.onRowEdit === true" v-ripple.400="'rgba(113, 102, 240, 0.15)'"
              ...
              <b-form-input v-model.trim="search" @keyup="paginated_users_to_assign" />
              <b-dropdown-item v-for="employee in paginated_users_to_assign" :key="employee.name"
        ...
        <template #cell(status)="data">
          <b-badge v-if="DaysLeft(data.item.created_at, data.item.due_date) >= 0" :variant="
            buttonVariant(
          ...
          ">
            ...
            {{
              data.item.status_master != null ? data.item.status_master.type : 0
            }}
          </b-badge>
            ...
            <b-col md="6">
              <b-form-group label="Contact">
                <v-select v-on:input=" autofillContact " v-model=" pcontact " placeholder="Search Contact"
                  class="select-size-md" label="name" :options=" show_contactPerson ">
                  <template #list-header>
          ...
          <b-row>
            <b-col md="4">
              <ValidationProvider #default=" validationContext " name="client" vid="client" rules="required">
                ...
                <b-form-group label="Client Name *">
                  <v-select id="client" v-model=" payment.client " placeholder="Search Client" :options=" show_companys "
                    label="name">
                  </v-select>
                  <b-form-invalid-feedback class="d-block">
                    {{ validationContext.errors[0] }}
            ...
            <b-col md="4">
              <validation-provider #default=" validationContext " name="branch" vid="payment-branch" rules="required">
                <b-form-group label="Payment Branch">
                  <v-select id="payment-branch" v-model=" payment.branch " placeholder="Payment Branch"
          ...
          <b-row>
            <b-col md="4">
              <b-form-group label="Payment Amount">
                <b-form-input v-model.number=" payment.amount " type="number"></b-form-input>
              </b-form-group>
            </b-col>
            <b-col md="4">
...
" class="">
                      ...
                      <td v-if=" payment.tax ">
                        <b-form-input @input=" setTds(invoice.id, $event) " :value=" setedittds(invoice.id) "
                          type="number" class="hide form-control" :id=" String(invoice.id) "></b-form-input>
                      </td>
                      <td aria-colindex="6" role="cell" class="">
                        <div class="form-group m-0">
                          ...
                          <div class="form-line">
                            <b-form-input @input=" setPayment(invoice.id, $event) " type="number"
              ...
              <ValidationProvider v-if=" invoiceTitle == 'add' " #default=" validationContext " name="client"
                ...
                <b-form-group>
                  ...
                  <v-select v-on:input=" autofillClient " label="name" v-model=" invoice.client "
                    placeholder="Search Client" class="select-size-md" id="invoice_client" :options=" show_companys ">
                    <template #list-header>
                      <div class="ml-2 mb-1 mt-1" v-b-modal.modal-clients>
                        <!--  <b-button size="sm" variant="primary"   v-b-modal.modal-1>
                    ...
                    <tr>
                      ...
                      <td style="width: 10%;">
                        <b-form-input readonly class="text-right" placeholder="IGST" style="
                                    ...
                                    border-left: none;
                                    border-right: none;
                                  " type="number" v-model=" invoice.igst_amt "></b-form-input>
                      </td>
                      <td style="width: 15%;">
                    ...
                    <tr>
                      ...
                      <td style="width: 10%;">
                        <b-form-input readonly class="text-right" placeholder="SGST" style="
                                    ...
                                    border-left: none;
                                    border-right: none;
                                  " type="number" v-model=" invoice.sgst_amt "></b-form-input>
                      </td>
                      <td style="width: 15%;"></td>
                    </tr>
                    <tr>
                      ...
                      <td style="width: 10%;">
                        <b-form-input readonly class="text-right" placeholder="CGST" style="
                                    ...
                                    border-left: none;
                                    border-right: none;
                                  " type="number" v-model=" invoice.cgst_amt "></b-form-input>
                      </td>
                      <td style="width: 15%;"></td>
                    </tr>
                    <tr>
                      ...
                      <td style="width: 10%;">
                        <b-form-input readonly class="text-right" placeholder="UTGST" style="
                                    ...
                                    border-left: none;
                                    border-right: none;
                                  " type="number" v-model=" invoice.utgst_amt "></b-form-input>
                      </td>
                      <td style="width: 15%;"></td>
                    </tr>
                  </tbody>
        ...
        <b-form @submit.prevent=" handleSubmit(editProposal) ">
          ...
          <b-row v-for="(  amount, index  ) in   amountField  " :key=" index ">
            ...
            <b-col class="d-flex flex-column" md="4">
              <ValidationProvider #default=" validationContext " name="amount" vid="amount" rules="required">
                <b-form-group label="Amount *">
                  <b-form-input type="number" v-model=" amount.amount " placeholder="Enter Amount" />
          ...
          <b-row>
            <b-col md="12">
              <b-form-group label="Internal Notes (Not visible for clients)">
                <b-form-input v-model=" pnotes " placeholder="Enter Notes">
                </b-form-input>
              </b-form-group>
            </b-col>
          </b-row>
      ...
      <b-row>
        ...
        <b-col md="6">
          <b-form-group label="Next Number">
            <b-form-input type="number" v-model=" lastInvoiceId " placeholder="Next Number"></b-form-input>
          </b-form-group>
        </b-col>
      </b-row>
      <!-- <b-row> -->
...
name:"LeadsTableGlobal",
  ...
  computed: {
    ...
    totalCount() {
      ...
      // // return count
      // }
      return this.childFunction.length;
    },
    items() {
...
//  THIS CREATED SECTION IS COMMMENTED BCOZ IT IS CREATING PROBLEM IN THE CODE, THE CODE IS REFRESHING SO COMMENTED IT
created() {
...
// toast.success('you did it');
  ...
  const invoicesAllData = this.$store.state.invoice.allData;
    ...
    this.invoice.prefix = invoicesAllData[invoicesAllData.length - 1].invoice_number.split(this.lastInvoiceId)[0]
  ...
  methods: {
    ...
    getAmountForProposals(data) {
      ...
      let totalFees = 0;
      if(data.proposal_fees.length > 1){
...
//     }
 //   ,
    ...
    onRowClicked(item) {
      ...
      if (detailsRowLeads && detailsRowLeads !== item) {
