<template>
  <div class="mt--4">
    ...
    <div>
      <b-modal no-close-on-backdrop id="modal-expense" ref="modal-expense" size="lg" hide-footer>
        <!-- <b-card-body> -->
        ...
        <validation-observer #default="{ handleSubmit }" ref="refFormObserver">
          ...
          <b-form @submit.prevent="handleSubmit(onSubmit)">
            ...
            <b-row>
              <b-col :md="'12'">
                <validation-provider #default="validationContext" name="task" vid="task" rules="required">

                  <b-form-group label="Task/Lead *">
                    <v-select id="task" v-model="formData.task" :options="allData" label="subject"
                  ...
                  <feather-icon size="14" style="margin-right: 0.5rem;"  icon="SearchIcon" /> Add Contacts</b-button> -->
                          <a href="#">
                            <feather-icon size="14" style="margin-right: 0.5rem;" icon="PlusIcon" /> New Lead/Task
                          </a>
                      ...
                      <template #option="item">
                        <div class="d-flex justify-content-between">
                          ...
                          <div>
                            <b-badge :variant="buttonVariant(item.self_user.status)">
            ...
            <div v-if="formData.task != null" class="col-sm-12">
              <table class="client-details-table table">
                <thead>
                  <tr>
                    <th class="padding-10">Client
                      Name
                    </th>
                    <td style="background-color: #f3f2f7;color:black">
                      {{formData.task.company != null  ?formData.task.company.name : '-'}}
                    </td>
                    <th class="">
                      Contact Person
                    </th>
                    <td style="background-color: #f3f2f7;color:black">{{formData.task.contact_person ? formData.task.contact_person.name : '-'}}</td>
                  </tr>
                </thead>
              </table>
            </div>
            ...
            <div class="mt-1 text-right ">
              ...
              <b-button size="sm" :disabled="$store.state.expenses.isSidebarLoading" variant="primary" type="submit">
                Save
                <b-spinner small class="ml-1" v-if="$store.state.expenses.isSidebarLoading" />
              </b-button>
            </div>
          </b-form>
        </validation-observer>
