<template>
    <div class="mt--4">
      ...
      <div>
        <b-modal no-close-on-backdrop id="modal-expense-leads" ref="modal-expense-leads" size="lg" hide-footer>
          <!-- <b-card-body> -->
              ...
              <b-row class="mt-2">
                ...
                <b-col :md="'3'">
                  <validation-provider #default="validationContext" name="expense" vid="expense" rules="required">
                    ...
                    <b-form-group label="Expense *"  class="my-custom-select">
  ...
  export default {
    ...
    methods: {
      ...
      closeModal() {
        this.$refs['modal-expense-leads'].hide()
        this.resetFormData()
      },
      onSubmit() {
        let users = []
