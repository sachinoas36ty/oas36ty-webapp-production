<template>
  <div>
    <b-modal
      @hidden="resetPaymentSectionModal2Details"
      no-close-on-backdrop
      id="PaymentSectionModal2"
      ref="PaymentSectionModal2"
      size="lg"
      hide-footer
    ...
    >
      <validationObserver #default="{ handleSubmit }" ref="refFormObserver">
        <b-form @submit.prevent="handleSubmit(handleSubmitCreatePayment)">
            ...
            <b-col md="4">
              <b-form-group label="Payment Amount">
                <b-form-input
                  ...
                  :state="payment.amount ? null : false"
                  @input="checkGreaterAmount"
                  type="number"
                ></b-form-input>
                <template #invalid-feedback> Please Enter Amount </template>
              </b-form-group>
              <div
                v-if="greaterAmountSingle"
          ...
          <!-- extend start here -->
          <div v-if="payment.client" data-v-6d78c756="" class="">
            <div data-v-6d78c756="">
          ...
          <b-row>
            ...
            <b-col class="text-right">
              <b-button
                ...
                class="mr-1"
                variant="primary"
                @click="$refs['PaymentSectionModal2'].hide()"
                @hidden="resetPaymentSectionModal2Details"
              >
...
export default {
  ...
  methods: {
    ...
    resetPaymentSectionModal2Details() {
    ...
    handleSubmitCreatePayment() {
      ...
      this.$store.dispatch("recordPayment/store", data).then(() => {
        this.$refs["PaymentSectionModal2"].hide()
