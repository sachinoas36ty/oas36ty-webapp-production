<template>
  ...
  <div>
     {{ defaultEmail }}
    <b-modal no-close-on-backdrop id="modal-tasks" ref="modal-tasks" size="lg" hide-footer 
      ...
      <validation-observer #default="{ handleSubmit }" ref="refFormObserver">
        ...
        <b-form @submit.prevent="handleSubmit(onSubmit)">
          ...
          <b-row>
            <b-col v-if="!isChecked" :md="setMd(branches.length)">
              <validation-provider #default="validationContext" name="contact_person_id" vid="contact" rules="required"
               >
                ...
                <b-form-group label="Contact Person *" v-if="isChecked==false" class="my-custom-select">
                  <v-select id="contact" v-model="formData.contact_person_id" :options="contactPeople" label="name"
            ...
            <b-col v-if="!isChecked" :md="setMd(branches.length)">
              <validation-provider #default="validationContext" name="company_id" vid="client" rules="required"
                >
                <b-form-group class="my-custom-select" label="Client *" >
                  <v-select id="client" :options="clients" label="name" v-model="formData.company_id"
            ...
            <b-col v-if="!isChecked" :md="setMd(branches.length)">
              <b-form-group class="my-custom-select" label="Category" >
            ...
            <b-col :md="setMd(branches.length)" v-if="(branches.length > 1) || isChecked">
              <validation-provider #default="validationContext" name="branch_id" vid="branch" rules="required">
                ...
                <b-form-group class="my-custom-select" label="Branch *" >
          ...
          <validation-provider #default="validationContext" name="subject" vid="subject" rules="required">
            <b-row>
              <b-col md="12 ">
                <b-form-group class="my-custom-select" label="Subject *" label-for="contact">
          ...
          <b-row>
            <b-col md="12 ">
              <b-form-group class="my-custom-select" label="Description" label-for="contact">
          ...
          <b-row>
            <b-col :md="setSpecialMd()">
              <b-form-group class="my-custom-select" label="Assigned To">
            ...
            <b-col :md="setSpecialMd()">
              <validation-provider #default="validationContext" name="due_date" vid="due_date" rules="required">
                ...
                <b-form-group class="my-custom-select" label="Due Date *">
            ...
            <b-col :md="setSpecialMd()">
              <validation-provider #default="validationContext" name="priority" vid="priority" rules="required">
                ...
                <b-form-group class="my-custom-select" label="Priority *">
          ...
          /> -->
            ...
            <b-col :md="setSpecialMd()">
              <validation-provider #default="validationContext" name="amount" vid="amount" rules="required">

              <b-form-group class="my-custom-select" label="Value *">
                <b-form-input id="amount" v-model.number="formData.amount" type="number" placeholder="value">
...
export default {
  ...
  computed: {
    ...
    if(this.paginated_clients.length > 0){

      this.formData.company_id = this.paginated_clients[0]
    }else{
      this.formData.company_id = null
    }
    if(this.branches.length > 1 || this.branches.length === 1){
