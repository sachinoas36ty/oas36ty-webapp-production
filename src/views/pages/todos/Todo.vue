          ...
          >
            ...
            <div class="todo-title-wrapper">
              ...
              <div class="todo-item-action">
                ...
                <small class="text-nowrap text-muted mr-1">{{ formatDate(task.dueDate) }}</small>
                <b-avatar
                  v-if="task.assignee"
                  size="32"
...
import {
  ...
  BFormCheckbox, BBadge, BAvatar,BSpinner
} from 'bootstrap-vue'
    ...
    const fetchTasks = () => {
      store.dispatch('appTodo/fetch', {
        ...
        .then(response => {
          ...
          tasks.value = store.state.appTodo.all
        })
    }
