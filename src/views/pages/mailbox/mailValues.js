...
export default function mailFunctions(){
  function isInFolder(email,folder) {
    ...
    // return !task.isDeleted
         ...
         function getEmail(folder='inbox',label)
         {
          const filteredData = data.emails.filter(email =>isInFolder(email,folder) &&(label ? email.labels.includes(label) : true) )
