...
export default {
  ...
  created() {
    ...
    if (loggedIn) {
      this.$store.dispatch('tasks/audits')

      // if (this.$store.state.subtaskTemplate.all.length === 0) {
      ...
      if (this.$store.state.status.all_master.length === 0) {
      ...
      // }
      // if (this.$store.state.tasks.all.filter(e => e.type === 'task').length === 0) {
      //   this.$store.dispatch('tasks/fetchwithoutLoading')

      // }
  //     if(this.$store.state.clients.all.length === 0){
  //   this.$store.dispatch('clients/fetch')
  // }
  // if(this.$store.state.contactPeople.all.length === 0){
