...
const END_POINT = APP_URL+'/branches'
...
const states = async () => await axios.get(`${APP_URL}/get-states`, config)

const business = async () => await axios.get(`${APP_URL}/business-type`, config)

const logo = payload => axios.post(`${APP_URL}/addBranch-logo`, payload, config)
