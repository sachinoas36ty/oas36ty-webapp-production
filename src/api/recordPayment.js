...
const END_POINT = APP_URL+'/record-payment'
const END_POINT_Multiple = APP_URL +'/record-multiple-payment'
...
const updateMultiple = ({ payload, id }) => axios.put(`${END_POINT_Multiple}/${id}`, payload, config)


const destroy = id => axios.delete(`${END_POINT}/${id}`, config)

const storeMultiple = payload => axios.post(END_POINT_Multiple, payload, config)
