...
const END_POINT = APP_URL+'/categories'
// const END_POINT = 'https://api-office36ty.protracked.in/v1/categories';
// const END_POINT = 'http://localhost:8000/v1/categories'
...
const update =  payload  => axios.post(`${APP_URL}/categories-multiple`, payload, config)
